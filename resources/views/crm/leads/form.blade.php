        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{{ old('title', $lead->title ?? '') }}"
            ...
            <div class="col-lg-5 col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="full_name"
                        value="{{ old('full_name', $lead->full_name ?? '') }}" placeholder="Enter Full Name">
                </div>
            </div>
            <div class="col-lg-5 col-6">
                <div class="form-group">
            ...
            <div class="col-lg-6 col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="telephone"
                        value="{{ old('telephone', $lead->telephone ?? '') }}" placeholder="Enter Telephone">
                </div>
            </div>
            <div class="col-lg-6 col-6">
                <div class="form-group">
            ...
            <div class="col-lg-6 col-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="lead_value"
                        value="{{ old('lead_value', $lead->lead_value ?? '') }}" placeholder="Enter Lead Value ($)">
                </div>
            </div>
            <div class="col-lg-6 col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="assigned"
                        value="{{ old('assigned', $lead->assigned ?? '') }}" placeholder="Enter Name">
                </div>
            </div>
            <div class="col-lg-12 col-12">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tags" value="{{ old('tags', $lead->tags ?? '') }}"
            ...
            <div class="col-lg-12 col-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="total_budget"
                        value="{{ old('total_budget', $lead->total_budget ?? '') }}" placeholder="Enter Total Budget">
                </div>
            </div>
            <div class="col-lg-12 col-12">
                <div class="form-group">
            ...
            <div class="col-lg-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="brand_name"
                        value="{{ old('brand_name', $lead->brand_name ?? '') }}" placeholder="Enter Brand Name">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="street"
                        value="{{ old('street', $lead->street ?? '') }}" placeholder="Street">
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="form-group">
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="zip_code"
                        value="{{ old('zip_code', $lead->zip_code ?? '') }}" placeholder="Enter Zip Code">
                </div>
            </div>
            ...
            <div class="col-lg-12 col-12">
                <div class="form-group">
                    ...
                    <input type="url" class="form-control" name="website"
                        value="{{ old('website', $lead->website ?? '') }}" placeholder="Enter Website">
                </div>
            </div>
        </div>
    </div>
