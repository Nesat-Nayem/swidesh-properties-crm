        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" action="{{ route('payments.update', $payment->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="invoice_id" name="invoice_id" value="{{ $payment->invoice_id }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="notes" name="notes" rows="4">{{ $payment->notes }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
